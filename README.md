...
A browser-only toolbox presented as a fast, installable app drawer. The first tools are a QR scanner and GPS speedometer; more focused utilities can be added as SvelteKit routes.
